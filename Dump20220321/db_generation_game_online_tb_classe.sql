...
CREATE TABLE `tb_classe` (
  `classe_id` bigint NOT NULL AUTO_INCREMENT,
  `nome` varchar(15) NOT NULL,
  `arma` varchar(14) DEFAULT NULL,
...
INSERT INTO `tb_classe` VALUES (1,'guerreiro','espada'),(2,'mago','cajado'),(3,'elfo','arco'),(4,'anão','machado');
